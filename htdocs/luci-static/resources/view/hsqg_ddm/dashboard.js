...
return view.extend({
	...
	render: function(data) {
		...
		var getRxQuality = function(rx, th) {
			...
			var lowAlarm = (th && th.rx_pwr_low_alarm !== undefined) ? th.rx_pwr_low_alarm : -30.0;
			var lowWarn = (th && th.rx_pwr_low_warn !== undefined) ? th.rx_pwr_low_warn : -27.0;
		...
		var getTxQuality = function(tx, th) {
			...
			var lowAlarm = (th && th.tx_pwr_low_alarm !== undefined) ? th.tx_pwr_low_alarm : -1.0;
			var lowWarn = (th && th.tx_pwr_low_warn !== undefined) ? th.tx_pwr_low_warn : 0.5;
			var highWarn = (th && th.tx_pwr_high_warn !== undefined) ? th.tx_pwr_high_warn : 5.0;
			var highAlarm = (th && th.tx_pwr_high_alarm !== undefined) ? th.tx_pwr_high_alarm : 6.5;
